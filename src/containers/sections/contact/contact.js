      ...
      <div className="contentContact">
        <div className="left">
          <div className="contentText-left">
            ...
            <p>
              A Wendy tem como foco trazer o máximo de segurança e respeito para
              os trabalhadores, queremos levar nossa perspectiva de segurança do
              trabalho combinando design e tecnologia.
            </p>
            <p>
              Nós queremos apresentar na primeira versão nossas ideas, nossos
              desejos e sentimentos para os usuários do nosso aplicativo, somos
              fissurados em inovação, simplicidade e criação de valor a long
              prazo. Nossa cultura é fazer o mundo se sentir mais seguro com a
              AdaWendy.
            </p>
            <p>
          ...
          <div className="contentRight">
            <div className="idealizador">
              ...
              <span className="description">
                ...
                estudante da área de segurança do trabalho e viciado em consumir
                qualquer coisa que envolva tecnologia.
              </span>
              <hr class="solid"></hr>
